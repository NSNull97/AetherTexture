...
final class AetherMotionTests: XCTestCase {
    ...
    func testMotionProfilesKeepMenuTimingAndNavigationIndependent() {
    ...
    func testContextMenuBloomOpeningUsesMeasuredIndependentXYPeakWindowsAt120Hz() throws {
        ...
        let heightPeakMilliseconds = heightPeak.rawProgress
            * CGFloat(ContextMenuController.glassmorphicTiming.openDuration)
            * 1_000.0
        XCTAssertEqual(widthPeakMilliseconds, 233.0 * ContextMenuController.glassmorphicTiming.openDuration / 0.32, accuracy: 10.0)
        XCTAssertEqual(heightPeakMilliseconds, 222.0 * ContextMenuController.glassmorphicTiming.openDuration / 0.32, accuracy: 14.0)
