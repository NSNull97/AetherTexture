...
/// Breaks the strong `CADisplayLink -> target -> owner` cycle. The link owns
/// this forwarding target, while callbacks capture their real owner weakly.
final class AetherDisplayLinkTarget: NSObject {
