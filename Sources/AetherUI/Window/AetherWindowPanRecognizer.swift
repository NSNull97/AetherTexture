...
/// Custom gesture recognizer for interactive keyboard dismissal.
///
/// Tracks recent touch points to estimate vertical velocity, enabling
/// smooth pan-to-dismiss-keyboard behavior. Does not cancel or delay
/// touches in the underlying views (pass-through).
public final class AetherWindowPanRecognizer: UIGestureRecognizer {
