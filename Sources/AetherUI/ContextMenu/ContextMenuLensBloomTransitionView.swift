...
final class ContextMenuLensBloomTransitionView: UIView {
    ...
    private let debugProgressLabel = AetherTextNodeOverlayView()
    private let debugSourceModeLabel = AetherTextNodeOverlayView()
...
//        assert(box.maxX <= bounds.maxX + 2.0 && box.maxY <= bounds.maxY + 2.0, "LensBloom shadow path must stay inside transition bounds.")
    ...
    private func configureDebugLabel(_ label: AetherTextNodeOverlayView) {
