...
private extension UIView {
    var edgeEffectStore: EdgeEffectAttachmentStore? {
        get { objc_getAssociatedObject(self, &edgeEffectStoreKey) as? EdgeEffectAttachmentStore }
        set { objc_setAssociatedObject(self, &edgeEffectStoreKey, newValue, .OBJC_ASSOCIATION_RETAIN_NONATOMIC) }
    }
}
